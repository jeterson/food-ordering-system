...
import com.food.ordering.system.order.service.application.domain.ports.output.message.publisher.restaurantapproval.OrderPaidRestaurantRequestMessagePublisher;
...
public class PayOrderKafkaMessagePublisher implements OrderPaidRestaurantRequestMessagePublisher {
    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            var restaurantApprovalRequestAvroModel = orderMessagingDataMapper
